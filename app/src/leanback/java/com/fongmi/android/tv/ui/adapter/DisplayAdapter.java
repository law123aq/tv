...
public class DisplayAdapter extends RecyclerView.Adapter<DisplayAdapter.ViewHolder> {
    ...
    public DisplayAdapter() {
        ...
        mItems.add(ResUtil.getString(R.string.play_size));
    }
    ...
    private boolean getChecked(int position) {
        ...
        else if (position == 4) return Setting.isDisplaySize();
        return false;
    }
    ...
    private boolean onItemLongClick(int position) {
        ...
        else if (position == 4) checked = Setting.isDisplaySize();
        ...
        Setting.putDisplaySize(!checked);
        notifyItemRangeChanged(0, getItemCount());
        return true;
    }
